...
export class Migrationcreate1729704998051 implements MigrationInterface {
    name = 'Migrationcreate1729704998051'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "navigation_item" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying NOT NULL, "url" character varying, "index" integer NOT NULL DEFAULT '0', "mpath" character varying DEFAULT '', "parentId" character varying, "navigationId" character varying, CONSTRAINT "PK_f1ab5d46bde4308ca87f4c60378" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "navigation_item" ADD CONSTRAINT "FK_4f4d31fc778461c8e93c96ce1d7" FOREIGN KEY ("parentId") REFERENCES "navigation_item"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
